= Aerobic Composting Control System
...
image:https://img.shields.io/badge/Contribute%20on-GitHub-orange[Contribute on GitHub, link=https://github.com/pylar-io/aerobic-composting-control-system.git]
